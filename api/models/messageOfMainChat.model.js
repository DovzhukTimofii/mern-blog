...
const messageOfMainChatSchema = new mongoose.Schema(
  {
    message: {
      type: String,
      required: true,
...
const MessageOfMainChat = mongoose.model('messageOfMainChat',  messageOfMainChatSchema);

export default MessageOfMainChat;